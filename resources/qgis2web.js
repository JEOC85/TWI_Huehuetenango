...
map.getView().fit([353528.675584, 1725470.822206, 434541.432191, 1779850.519081], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">INDICE DE HUMEDAD TOPOGRAFICA DEPARTAMENTO DE HUEHUETENANGO</h2>';
        return titleElement;
    })(),
